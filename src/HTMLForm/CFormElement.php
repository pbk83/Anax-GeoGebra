    ...
    public static function create($name, $attributes)
    {
        ...
        $types = [
            ...
            'checkbox-multiple' => '\Anax\HTMLForm\CFormElementCheckboxMultiple',
						'tag-selector' 			=> '\Anax\HTMLForm\CFormElementTagSelector',
            // Address
        ];
...
EOD;
        ...
        }	elseif ($this['type'] == 'tag-selector') { 
						return "<label>Tags</label><input id='mySingleField' type='hidden' {$class}{$name}{$value} />\n<ul id='singleFieldTags'></ul>";
				}
